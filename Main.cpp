...
VOID wrkWndw()
{
	...
	wcex2.hIcon          = LoadIcon(hInst, MAKEINTRESOURCE(IDI_ICON2));
	wcex2.hCursor        = LoadCursor(NULL, IDC_ARROW);
	wcex2.hbrBackground  = (HBRUSH)(COLOR_WINDOW);
	wcex2.lpszClassName  = szWindowClass2;
	wcex2.hIconSm        = LoadIcon(wcex2.hInstance, MAKEINTRESOURCE(IDI_ICON3));
...
LRESULT CALLBACK WndProc1(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_PAINT:
		{
			hdc = BeginPaint(hWnd, &ps);
			GetTextExtentPoint32(hdc, L"Choose Your Destiny:", lstrlen(L"Choose Your Destiny:"), &sz);
			EndPaint(hWnd, &ps);
			HGDIOBJ hFont = CreateFont(48, 0, 0, 0, FW_REGULAR, FALSE, FALSE, FALSE, ANSI_CHARSET, OUT_TT_PRECIS, CLIP_DEFAULT_PRECIS, DEFAULT_QUALITY, DEFAULT_PITCH | FF_DONTCARE, L"Times New Roman");
			HWND hTxtDest = CreateWindowEx(NULL, L"STATIC", L"Choose Your Destiny:", WS_CHILD|WS_VISIBLE, 225-(sz.cx), 20, 500, 48, hWnd, NULL, NULL, NULL);
...
#pragma region interface
			...
			CreateWindowEx(NULL, L"STATIC", L"Button", ES_CENTER|WS_CHILD|WS_VISIBLE, (100-sz.cx)/2+20, 10, sz.cx, sz.cy, hWnd, NULL, NULL, NULL);
			...
			EndPaint(hWnd, &ps);
			NUM[0]	= CreateWindowEx(NULL,L"BUTTON",L"0",BS_DEFPUSHBUTTON|WS_CHILD|WS_VISIBLE,20,40,100,35,hWnd,(HMENU)ZERO_NUM, NULL,NULL);
			NUM[1]	= CreateWindowEx(NULL,L"BUTTON",L"1",BS_DEFPUSHBUTTON|WS_CHILD|WS_VISIBLE,47,95,45,45,hWnd,(HMENU)ONE_NUM, NULL,NULL);
			NUM[2]	= CreateWindowEx(NULL,L"BUTTON",L"2",BS_DEFPUSHBUTTON|WS_CHILD|WS_VISIBLE,47,160,45,45,hWnd,(HMENU)TWO_NUM, NULL,NULL);
			NUM[3]	= CreateWindowEx(NULL,L"BUTTON",L"3",BS_DEFPUSHBUTTON|WS_CHILD|WS_VISIBLE,47,225,45,45,hWnd,(HMENU)THREE_NUM, NULL,NULL);
			NUM[4]	= CreateWindowEx(NULL,L"BUTTON",L"4",BS_DEFPUSHBUTTON|WS_CHILD|WS_VISIBLE,47,290,45,45,hWnd,(HMENU)FOUR_NUM, NULL,NULL);
			NUM[5]	= CreateWindowEx(NULL,L"BUTTON",L"5",BS_DEFPUSHBUTTON|WS_CHILD|WS_VISIBLE,47,355,45,45,hWnd,(HMENU)FIVE_NUM, NULL,NULL);
			NUM[6]	= CreateWindowEx(NULL,L"BUTTON",L"6",BS_DEFPUSHBUTTON|WS_CHILD|WS_VISIBLE,47,420,45,45,hWnd,(HMENU)SIX_NUM, NULL,NULL);
			NUM[7]	= CreateWindowEx(NULL,L"BUTTON",L"7",BS_DEFPUSHBUTTON|WS_CHILD|WS_VISIBLE,47,485,45,45,hWnd,(HMENU)SEVEN_NUM, NULL,NULL);
			NUM[8]	= CreateWindowEx(NULL,L"BUTTON",L"8",BS_DEFPUSHBUTTON|WS_CHILD|WS_VISIBLE,47,550,45,45,hWnd,(HMENU)EIGHT_NUM, NULL,NULL);
			NUM[9]	= CreateWindowEx(NULL,L"BUTTON",L"9",BS_DEFPUSHBUTTON|WS_CHILD|WS_VISIBLE,47,615,45,45,hWnd,(HMENU)NINE_NUM, NULL,NULL);
